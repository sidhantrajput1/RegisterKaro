...
export const NavBar = () => {
  ...
  return (
    <div>
      {/* Hide Header on sm and md screens */}
      <Header />
      ...
      <div className="bg-white shadow-md">
        <div className="flex justify-between mx-auto max-w-7xl p-3 items-center">
          ...
          <div className="lg:hidden">
            {isMenuOpen ? (
              <p onClick={toggleMenu} className="text-2xl cursor-pointer">
                X
              </p>
            ) : (
              <FaHamburger
          ...
          >
            ...
            >
              ...
              <li className="relative">
                ...
                {isDropdownOpen && (
                  <ul
                    className="border absolute mt-3 bg-white border-gray-200 shadow-lg rounded-lg w-[250px]"
...
export const Header = () => {
  return (
    <div className="bg-sky-700 p-2 hidden md:block">
      <div className="flex justify-between items-center">
        ...
        <div className="flex justify-end gap-5 pr-2">
          ...
          <div className="socail-media icons flex gap-3">
            <a href="">
