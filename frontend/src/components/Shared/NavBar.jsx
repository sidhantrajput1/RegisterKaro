        ...
        <div className="  flex justify-between  mx-auto max-w-7xl p-3  items-center">
          ...
          <div className="flex items-center  ">
            <div className="flex gap-6 items-center justify-around">
              <ul
                className={`flex gap-6 items-center transition-all duration-100 ease-in-out ${
                  isShowSearch ? "-translate-x-4" : "translate-y-0"
                }`}
              >
                <li>
                  <a href="#">Home</a>
              ...
              <button className="p-2 bg-amber-500 font-medium text-white border rounded-md px-5">
                Talk an Expert
              </button>
            </div>
          </div>
...
export const SearchBar = ({ setIsShowSearch, isShowSearch }) => {
  ...
  return (
    <div className="flex items-center border border-gray-300 rounded-md px-4 py-2 bg-white shadow-md transition-all duration-200 ease-in-out">
      ...
      <p
        onClick={clearSearch}
        className="ml-2 text-gray-500 cursor-pointer hover:text-red-500 transition"
      >
        X
      </p>
    </div>
...
//   className={`bg-gray-400 border rounded-md w-[200px] p-1  transition-normal duration-500 ease-in-out ${
//     isShowSearch ? "opacity-100 translate-x-4" : "opacity-0 -translate-y-4"
//   }`}
// />
