  ...
  return (
    <div className="bg-white">
      <div className="max-w-7xl mx-auto p-5 flex justify-between items-center">
        ...
        {/* Left Section */}
        <div className="flex flex-col gap-6 w-[644px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button className="bg-[#1c4670] text-white w-[157px] py-3 px-6 text-center">
        ...
        <div>
          <img
            className="w-[579px] h-[418px] rounded-lg opacity-80 border border-orange-300"
